...
- Google App.Base feed is served only in default language [\#79](https://github.com/opencart/opencart/issues/79)
- Google App.Base feed excludes currency information [\#78](https://github.com/opencart/opencart/issues/78)
